...
public final class prediction2_jsp extends org.apache.jasper.runtime.HttpJspBase
...
User usr=new User();
	...
	int count=1;
      ...
      out.write("\t\t\t\t\t\t\t\t\tstyle=\"font-family: Monotype Corsiva; font-size: 35px; color: blue;\">Prediction 2</font></label></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\r\n");
...
while(rs1.next())
      ...
      out.write("\t\t\t\t\t</label></td><td> <select name=\"area\" id=\"area\" style=\"color: maroon;font-weight: bold;\" class=\"input\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"select\" selected=\"selected\" readonly=\"readonly\">--Select--</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
while(rs2.next())
									{
      ...
      out.write("\t\t\t\t\t\t\t\tstyle=\"color: maroon;font-weight: bold;\">Budget</font></label></td><td>\r\n");
      out.write("\t\t\t\t\t\t\t <input type=\"text\"\r\n");
      out.write("\t\t\t\t\t\t name=\"budget\" class=\"input\"\r\n");
      out.write("\t\t\t\t\t\tplaceholder=\"Budget\">&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
