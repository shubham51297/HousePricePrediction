...
public final class prediction3_jsp extends org.apache.jasper.runtime.HttpJspBase
...
User usr=new User();
	...
	int count=1;
      ...
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<input type=\"hidden\" name=\"no\" value=\"3\"></input>\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<center>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\tstyle=\"font-family: Monotype Corsiva; font-size: 35px; color: blue;\">Prediction 3&nbsp;&nbsp; </font></label></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\r\n");
...
while(rs1.next())
	...
	if(Utility.parse(request.getParameter("no"))==3)
    {
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t<td><font style=\"color: maroon;font-weight: bold;\">Prediction 3</font></td>\r\n");
      out.write("\t\t\t\t\t<td></td>\r\n");
      out.write("\t\t\t\t\t<td><font style=\"color: maroon;font-weight: bold;\">");
      out.print(prediction3);
