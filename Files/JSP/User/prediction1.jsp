...
<body onload="startTimer()">
				...
				<table style="width: 100">
					...
					<tr>
							<td align="center" colspan="5"><label><font
									style="font-family: Monotype Corsiva; font-size: 35px; color: blue;">Prediction 1</font></label></td>
						</tr>
					...
					</label></td><td> <select name="area" id="area" style="color: maroon;font-weight: bold;">
								<option value="select" selected="selected" readonly="readonly">--Select--</option>
								<%while(rs2.next())
									{%>
					...
					<tr>
						<td> <label><font
								style="color: maroon;font-weight: bold;">Type</font></label></td><td>
							 <select name="type" id="type" style="color: maroon;font-weight: bold;">
								<option value="select" selected="selected" readonly="readonly">--Select--</option>
								<%while(rs3.next())
									{%>
    ...
    %>
					...
					<td></td>
					<td><font style="color: maroon;font-weight: bold;"><%=prediction1%> per Sqft</font></td>
					<%} %>
					</tr>
